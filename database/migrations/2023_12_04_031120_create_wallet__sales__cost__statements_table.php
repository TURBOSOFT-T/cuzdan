...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('wallet__sales__cost__statements', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('produt_bare_code_type')->nullable();
 ...
 */
    ...
    {
        Schema::dropIfExists('wallet__sales__cost__statements');
    }
};